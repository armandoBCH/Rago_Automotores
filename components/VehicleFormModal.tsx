...
const VehicleFormModal: React.FC<VehicleFormModalProps> = ({ isOpen, onClose, onSubmit, initialData, brands }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                ...
                const signedUrlResponse = await fetch('/api/admin', {
                    ...
                    body: JSON.stringify({
                        ...
                        payload: { fileName: compressedFile.name, fileType: compressedFile.type }
                    }),
                });
        ...
        const fuelType = isOtherFuelType ? formData.customFuelType?.trim() : formData.fuel_type;
